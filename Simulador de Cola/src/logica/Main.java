...
public class Main {
	...
	*/
	...
	public static void main(String[] args) throws InterruptedException //float lArribos, float lServicio, int cantClientesAtendidos, int tiempoMaxSimulacion) throws InterruptedException 
	{
	    ...
	    lambda_tiempo_entre_arribos = lArribos;
	    System.out.println("Ingrese el tiempo de servicio:");
	    lambda_tiempo_servicio = lServicio;
	    System.out.println("Ingrese la cantidad de clientes:");
	    cantidad_clientes_atendidos_requeridos =  cantClientesAtendidos;
	    System.out.println("Ingrese el tiempo maximo de simulacion:");
	    tiempo_simulacion_maximo = tiempoMaxSimulacion; // parametros simulacion!
	     */
	    System.out.println("Ingrese el tiempo entre arribos:");
	    ...
	    System.out.println("Ingrese el tiempo maximo de simulacion:");
	    tiempo_simulacion_maximo =  s.nextInt(); // parametros simulacion!
